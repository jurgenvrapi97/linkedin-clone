...
const Jobs = () => {
  ...
  const categories = useSelector(
    (state) => state.allCategoryJobs.allCategoryJobs
  );
        ...
        {queryJobs.length > 0 ? (
          <>
            ...
            {queryJobs.slice(0, 30).map((job) => {
              return (
                <Col
                  className="bg-white p-0 border border-1 rounded-2 "
                  lg={6}
                  key={job._id}
                >
                  <Card className="px-4">
                    <Card.Body>
                      <Card.Title className="mb-3">
                        ...
                        <h6
                          ...
                          onClick={() => handleShowCompany(job.company_name)}
                        >
                          {job.company_name}
                        </h6>
                                  ...
                                  <Card className="px-4">
                                    <Card.Body>
                                      ...
                                      <div className="d-flex align-items-center ">
                                        <Card.Subtitle className="mb-2 text-muted me-2">
                                          Category:
                                        </Card.Subtitle>
                      ...
                      <div className="d-flex align-items-center ">
                        ...
                        <Card.Subtitle
                          className="mb-2 text-muted btn"
                          onClick={() => handleShowCategory(job.category)}
                        >
                          {job.category}
                        </Card.Subtitle>
                        <Modal show={showCategory} onHide={handleCloseCategory}>
                          <Modal.Header closeButton>
                            <Modal.Title>
                              Altri annunci per questa categoria:
                            </Modal.Title>
                          </Modal.Header>
                          <Modal.Body
                            style={{ maxHeight: "500px", overflowY: "auto" }}
                                  ...
                                  <Card className="px-4">
                                    <Card.Body>
                                      ...
                                      <div className="d-flex align-items-center ">
                                        ...
                                        <Card.Subtitle className="mb-2 text-muted">
                                          {" "}
                                          {category.candidate_required_location}
                                        </Card.Subtitle>
                                      </div>
                                      <Card.Link
                                        href="boh"
                      ...
                      <Card.Link href="boh" className="nav-link">
                        {job.url}
                      </Card.Link>
                    </Card.Body>
                  </Card>
